...
/*
    * Este archivo se encargará de definir el schema de mongoose para los cursos.
    ...
    ? Por ejemplo, el required, el cual especifica que, si o si se necesita recibir ese dato y enum, el cual recibe un array con las posibles opciones que se aceptan.
...
newCourse.index({name: 1}, {unique: true});
